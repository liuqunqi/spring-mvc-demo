...
import com.wandaph.openfeign.eureka.EurekaRegistry.DataCenterInstanceConfigExt;
...
public class TestFeignRibbon {
    public static void main(String[] args) throws Exception {
       ...
       /* Properties properties = new Properties();
        ...
        final DiscoveryClient client = new DiscoveryClient(applicationInfoManager, new DefaultEurekaClientConfig());*/


        EurekaRegistry eurekaRegistry = EurekaRegistry.getInstance();
        final DiscoveryClient client = eurekaRegistry.initEurekaClient("http://10.53.156.75:8761/eureka/","spring-mvc-web",8080);
        ...
        final ILoadBalancer loadBalancer = new ZoneAwareLoadBalancer(clientConfig, new ZoneAvoidanceRule(), new NIWSDiscoveryPing(), discoveryEnabledNIWSServerList, new DefaultNIWSServerListFilter());
