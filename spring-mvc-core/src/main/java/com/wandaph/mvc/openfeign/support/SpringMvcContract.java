...
package com.wandaph.mvc.openfeign.support;
...
import com.wandaph.mvc.openfeign.annotation.PathVariableParameterProcessor;
import com.wandaph.mvc.openfeign.annotation.QueryMapParameterProcessor;
import com.wandaph.mvc.openfeign.annotation.RequestHeaderParameterProcessor;
import com.wandaph.mvc.openfeign.annotation.RequestParamParameterProcessor;
...
import static  com.wandaph.mvc.openfeign.support.FeignUtils.addTemplateParameter;
...
public class SpringMvcContract extends Contract.BaseContract
	...
	private static final ParameterNameDiscoverer PARAMETER_NAME_DISCOVERER = new PrioritizedParameterNameDiscoverer();
	...
	private Annotation synthesizeWithMethodParameterNameAsFallbackValue(
		...
		if (defaultValue instanceof String
				&& defaultValue.equals(annotationAttributes.get("value"))) {
